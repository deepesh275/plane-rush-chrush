...
public class GoogleAdMobController : MonoBehaviour
{
...
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-8947607922376336/8600600317";
#elif UNITY_IPHONE
        string adUnitId = "";
#else
    ...
    public void RequestAndLoadInterstitialAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-8947607922376336/5876940454";
#elif UNITY_IPHONE
        string adUnitId = "";
#else
        string adUnitId = "unexpected_platform";
    ...
    public void RequestAndLoadRewardedAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-8947607922376336/7834935677";
#elif UNITY_IPHONE
        string adUnitId = "";
#else
        string adUnitId = "unexpected_platform";
        ...
        if (rewardedAd != null)
        {
            rewardedAd.Show((Reward reward) =>
            {
                var currentCoinsValue = PlayerPrefs.GetInt("currentCoins");
                 PrintStatus("currentCoinsValue" + currentCoinsValue);
