...
public class AdmobAdsScript : MonoBehaviour
{
    ...
    public string appId = "ca-app-pub-8947607922376336~7353525929";// "ca-app-pub-3940256099942544~3347511713";


#if UNITY_ANDROID
    string bannerId = "ca-app-pub-8947607922376336/6860633535";
    ...
    private void Start()
    {
        ...
        // ShowCoins();
        // debugtext.text = "load script ads";
// Assets\Plugins\Android\proguard-user.txt
        ...
        MobileAds.Initialize(initStatus => {
            ...
            print("Ads Initialised !!" + $"{initStatus}");
            debugtext.text = "load script ads";
    ...
    void CreateBannerView() {
        ...
        // debugtext = ToString(bannerView);
   
            // debugtext.text = $"{bannerView}";
